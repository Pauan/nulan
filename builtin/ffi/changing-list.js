...
const insert = (push, state, index, value, f) => {
  ...
  // *none
  case 0:
    return indexes["splice"](index, 0, -1);
...
export const transform_maybe = (changing, f) =>
  (push) => {
    ...
    return changing((x) => {
      ...
      // *set
      case 0:
        return set(push, state, x.a, f);

      // *insert
      case 1:
        return insert(push, state, x.a, x.b, f);

      // *update
      case 2:
        return update(push, state, x.a, x.b, f);

      // *remove
      case 3:
        return remove(push, state, x.a);
      }
    });
  };
